...
the categories within the `r outcome_name` outcome. 
...
While item content is typically thought to explain factor loadings, other properties
such as response mode can also influence factor loadings.
